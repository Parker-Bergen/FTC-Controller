...
public class TauDemo extends OpMode
{
    ...
    public void init()
    {
        ...
        //hangset = hardwareMap.dcMotorController.get("Hangset");
    ...
    public void loop()
    {
       ...
       // }
        ...
        telemetry.addData("Color Values", "Color: " + colorNXT.red() +" "+ colorNXT.green() +" " +colorNXT.blue());
